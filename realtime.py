...
xuanviet_image = face_recognition.load_image_file("training/HoangXuanViet_20522149/IPZg65qj.jpg")
...
while True:
    ...
    if process_this_frame:
        ...
        # Find all the faces and face encoding in the current frame of video
